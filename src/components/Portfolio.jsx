...
const API_URL = 'https://zeenobackend.vercel.app/api';
            ...
            {filtered.map((project, i) => (
              ...
              >
                <div className="portfolio-img-wrap">
                  <img src={project.imageUrl && (project.imageUrl.startsWith('http') || project.imageUrl.startsWith('data:')) ? project.imageUrl : `${IMAGE_BASE}${project.imageUrl || ''}`} alt={project.title} loading="lazy" />
      ...
      {selected && (
        <div className="modal-overlay" onClick={() => setSelected(null)}>
          <div className="modal-box" onClick={e => e.stopPropagation()}>
            ...
            <img src={selected.imageUrl && (selected.imageUrl.startsWith('http') || selected.imageUrl.startsWith('data:')) ? selected.imageUrl : `${IMAGE_BASE}${selected.imageUrl || ''}`} alt={selected.title} className="modal-img" />
